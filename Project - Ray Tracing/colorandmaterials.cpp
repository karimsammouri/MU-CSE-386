 ...
 *          This really should not be frequently used for opaque objects, since the object will
 *          not have any shading. Its main purpose is to support transparent objects.
