...
void buildScene() {
	IShape* plane = new IPlane(dvec3(0.0, -2, 0.0), dvec3(0.0, 1.0, 0.0));
    ...
    IDisk* disk2 = new IDisk(dvec3(-5.0, 0.0, 0.0), dvec3(1.0, 0.0, 1.0), 8.0);
    IClosedCylinderY* closedCylinder = new IClosedCylinderY(dvec3(6.0, -2.0, -5.0), 5, 6);
    ...
    scene.addTransparentObject(new TransparentIShape(disk2, red, 0.25));
    scene.addOpaqueObject(new VisibleIShape(closedCylinder, cyanPlastic));
