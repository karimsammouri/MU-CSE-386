...
//    HitRecord hit;
//    Ray ray(dvec3(0,0,0), glm::normalize(dvec3(0.577, 0.577, 0.577)));
//    ISphere sphere(dvec3(2,1,2), 1);
//    sphere.findClosestIntersection(ray, hit);
//    cout << hit.t << ' ' << hit.interceptPt << ' ' << hit.normal << endl;
