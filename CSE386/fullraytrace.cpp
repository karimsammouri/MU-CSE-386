...
ICylinderY* cylinderY = new ICylinderY(dvec3(5.0, 0.0, -5.0), 3.0, 5.0);
ICylinderZ* cylinderZ = new ICylinderZ(dvec3(11.0, 0.5, -15.0), 2.5, 8.0);
IClosedCylinderY* closedCylinderY = new IClosedCylinderY(dvec3(-12.0, 0.0, 10.0), 3.0, 4.0);
ISphere* sphere1 = new ISphere(dvec3(0.0, 0.0, 0.0), 3.0);
ISphere* sphere2 = new ISphere(dvec3(-7.0, 0.0, 1.0), 4.0);
IConeY* cone = new IConeY(dvec3(-5.0, 4.0, 8.0), 2.0, 6.0);
IPlane* clearPlane = new IPlane(dvec3(0.0, 0.0, 0.0), dvec3(0.0, 0.0, 1.0));

void buildScene() {
    scene.addOpaqueObject(new VisibleIShape(plane, tin));
    scene.addOpaqueObject(new VisibleIShape(cylinderY, silver, &im));
    scene.addOpaqueObject(new VisibleIShape(cylinderZ, redPlastic));
    scene.addOpaqueObject(new VisibleIShape(closedCylinderY, cyanPlastic));
	...
	scene.addTransparentObject(new TransparentIShape(clearPlane, red, 0.2));
