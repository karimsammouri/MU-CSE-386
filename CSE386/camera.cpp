...
/**
 * @fn	void RaytracingCamera::setupFrame(const dvec3& viewingPos, const dvec3& lookAtPt, const dvec3& up)
 ...
 *                      small when compared to the window's size, which is often in 100s of pixels.
 */
